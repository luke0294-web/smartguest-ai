...
const TRANSLATIONS = {
  ...
  pl: {
    ...
    goToPanel: "Wróć do strony głównej",
    ...
    return (
      <div className="flex h-[100dvh] items-center justify-center p-6">
        <div className="glass-panel p-8 rounded-3xl max-w-md text-center flex flex-col items-center gap-4">
          ...
          <Link href="/" className="mt-4 px-6 py-3 bg-primary text-primary-foreground rounded-xl font-medium shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all">
            {t.goToPanel}
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {property.whatsappNumber && (
              <a
                ...
                className="flex items-center gap-1.5 bg-white hover:bg-emerald-50 active:bg-emerald-100 text-emerald-800 text-[12px] font-semibold px-3 py-1.5 rounded-full transition-all shadow-md border border-emerald-100"
                title={t.helpBtn}
              >
