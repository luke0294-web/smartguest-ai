...
function QrModal({
  ...
  const buildPdfDocument = (): jsPDF => {
    ...
    doc.text("Powered by HeyCico", pageW / 2, pageH - 10, { align: "center" });
  ...
  const handleDownload = () => {
    try {
      ...
      doc.save("Cartello_Benvenuto_HeyCico.pdf");
    } catch {
    ...
    return (
      <div className="min-h-[100dvh] flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm mb-8">Accesso riservato amministratori HeyCico</p>
        ...
        <div className="max-w-7xl w-full mx-auto flex flex-col gap-6">
          ...
          <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 glass-panel p-6 sm:px-8 rounded-[2rem]">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-serif font-bold text-foreground leading-tight">HeyCico CEO</h1>
